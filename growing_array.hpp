...
/// We need an automatically growing array of given type.
...
class growing_array : public std::vector<T> {
    ...
    /// Default value used when resizing the array.
...
public:
    ...
    /// Index access operator. Constructs new elements if index is bigger than size.
    ...
    /// Prints statistics about array to standard output stream.
